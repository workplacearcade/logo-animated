...
var Logo = function (_Component) {
  ...
  _createClass(Logo, [{
    ...
    value: function componentDidMount() {
      this.state.rotate ? this.start() : false;
    }
  }, {
    key: 'componentWillReceiveProps',
    value: function componentWillReceiveProps(nextProps) {
      nextProps.rotate ? this.start() : this.stop();
    }
  }, {
    ...
    value: function shuffle() {
      this.state.rotation === 'backwards' ? this.interval = setInterval(this.shuffleColorsBackwards.bind(this), 100) : this.interval = setInterval(this.shuffleColors.bind(this), 100);
    }
  }, {
    key: 'shuffleColors',
    ...
    key: 'shuffleColorsBackwards',
    value: function shuffleColorsBackwards() {
      var newColors = this.state.colors;
...
Logo.propTypes = {
  rotate: _react2.default.PropTypes.bool.isRequired
};
